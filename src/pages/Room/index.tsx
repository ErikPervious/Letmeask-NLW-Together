      ...
      <header>
        <div className="content">
          ...
          <div> 
            ...
            <Button onClick={returnToLogin} isOutlined>Sair da sala</Button>
          </div>
        </div>
      </header>
      <main>
          ...
          <div className="form-footer">
            { user ? (
              ...
              <span>
                ...
                <button onClick={returnToLogin}>faça seu login</button>
                .
              </span>
            )}
        ...
        { questions.length > 0 ?
          ...
          :
          <span className="notQuestion">Esta sala não tem perguntas, <br/>seja o(a) primeiro(a) a perguntar.</span>   
        }
      </main>
    </div>
  )
